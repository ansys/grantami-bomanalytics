...
# # BoM sustainability summary: Process phase
#
...
# ## Example scope
#
# This example only shows the ``primary_processes_details``, ``secondary_processes_details``, and
# ``joining_and_finishing_processes_details`` sustainability summary properties. For other properties,
