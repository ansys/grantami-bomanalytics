.. _ref_grantami_bomanalytics_bom_api_2301:

23/01 BoM object model
======================
...
.. note::
   ...
   * ``NonMIPartReference`` on :class:`~ansys.grantami.bomanalytics.bom_types.eco2301._bom_types.Part`
   * ``Annotations`` and ``AnnotationSources`` on :class:`~ansys.grantami.bomanalytics.bom_types.eco2301._bom_types.BillOfMaterials`
...
.. _ref_grantami_bomanalytics_api_23_01_billofmaterials:
