...
The :class:`~ansys.grantami.bomanalytics.bom_types.eco2412.BillOfMaterials` represents the root object in a 24/12 BoM hierarchy and can
...
.. toctree::
   ...
   bom_object_model_2301
   bom_object_model_2412
   builders
   helpers
   schemas
