...
This example uses Windows-based autologon authentication. For all supported authentication
schemes, see the :OpenAPI-Common:`OpenAPI-Common documentation <user_guide/index.html#authentication-schemes>`.
