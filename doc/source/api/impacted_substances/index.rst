...
[TECHDOCS] This section gives an overview of the impacted substances API. The
...
Granta MI database and determine the impacted substances both directly and indirectly associated with those records via
associated records in the Granta MI database. The :ref:`ref_grantami_bomanalytics_api_impactedsubstances_bom` query is
similar, but instead of records accepts a Bill of Materials in 1711 XML format, which in turn includes references to
Granta MI records.
