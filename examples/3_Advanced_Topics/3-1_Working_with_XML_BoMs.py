...
# takes the xml file and schema file and returns the result.
...
# If we were to try the same query with the invalid BoM, we would see a stack trace informing us that MI Service Layer
