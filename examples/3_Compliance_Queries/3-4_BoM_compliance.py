...
# Compliance queries can be performed on an XML BoM instead of a list
...
# For help on constructing an XML BoM, see the [bills of materials examples](../6_Bills_of_materials).
