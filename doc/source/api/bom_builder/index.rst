...
The :class:`ansys.grantami.bomanalytics.bom_types.BillOfMaterials` represents the root object in a BoM hierarchy, and can
...
Serialization and Deserialization of BoM objects can be performed using the :class:`ansys.grantami.bomanalytics.BoMHandler`
