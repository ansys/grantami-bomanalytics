  ...
  .. tab-item:: Miscellaneous
    ...
    .. list-table::
        ...
        * - Prepare 2.4.1 release
          - `#1009 <https://github.com/ansys/grantami-bomanalytics/pull/1009>`_
  ...
  .. tab-item:: Documentation
    ...
    .. list-table::
        ...
        * - Update documentation to refer to 2026 R1 help
          - `#1007 <https://github.com/ansys/grantami-bomanalytics/pull/1007>`_


`2.4.0 <https://github.com/ansys/grantami-bomanalytics/releases/tag/v2.4.0>`_ - March 05, 2026
==============================================================================================
  ...
  .. tab-item:: Dependencies
    ...
    .. list-table::
        ...
        * - Bump ansys/actions from 10.1.5 to 10.2.3 and implement Zizmor fixes
          - `#963 <https://github.com/ansys/grantami-bomanalytics/pull/963>`_

        * - Bump ansys/actions to 10.2.4
          - `#971 <https://github.com/ansys/grantami-bomanalytics/pull/971>`_

        * - Bump nbconvert to v7.17.0
          - `#977 <https://github.com/ansys/grantami-bomanalytics/pull/977>`_
  ...
  .. tab-item:: Miscellaneous
    ...
    .. list-table::
        ...
        * - Replace dev VM with 2026 R1 release VM
          - `#966 <https://github.com/ansys/grantami-bomanalytics/pull/966>`_

        * - Revert 2.4.0rc0 changelog
          - `#968 <https://github.com/ansys/grantami-bomanalytics/pull/968>`_

        * - Prepare 2.4.0rc1 release
          - `#997 <https://github.com/ansys/grantami-bomanalytics/pull/997>`_

        * - Bump version number
          - `#1000 <https://github.com/ansys/grantami-bomanalytics/pull/1000>`_
  ...
  .. tab-item:: Documentation
    ...
    .. list-table::
        ...
        * - Add External Database example
          - `#953 <https://github.com/ansys/grantami-bomanalytics/pull/953>`_

        * - Fix changelog fragments
          - `#995 <https://github.com/ansys/grantami-bomanalytics/pull/995>`_
  ...
  .. tab-item:: Maintenance
    ...
    .. list-table::
        ...
        * - Update missing or outdated files
          - `#919 <https://github.com/ansys/grantami-bomanalytics/pull/919>`_, `#930 <https://github.com/ansys/grantami-bomanalytics/pull/930>`_

        * - Create security check workflow
          - `#929 <https://github.com/ansys/grantami-bomanalytics/pull/929>`_
        ...
        * - Migrate to uv for package management and CI purposes
          - `#964 <https://github.com/ansys/grantami-bomanalytics/pull/964>`_

        * - Standardize uv run usage, add mypy to CI checks
          - `#972 <https://github.com/ansys/grantami-bomanalytics/pull/972>`_

        * - Fix permissions for documentation publish steps
          - `#976 <https://github.com/ansys/grantami-bomanalytics/pull/976>`_

        * - Stop cancelling all integration checks if one fails
          - `#982 <https://github.com/ansys/grantami-bomanalytics/pull/982>`_
  ...
  .. tab-item:: Test
    ...
    .. list-table::
        ...
        * - Add more specific assertions to examples tests
          - `#958 <https://github.com/ansys/grantami-bomanalytics/pull/958>`_
