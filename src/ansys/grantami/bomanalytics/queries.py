...
class _MaterialQueryBuilder(_RecordBasedQueryBuilder, ABC):
    ...
    def with_material_ids(self: Query_Builder, material_ids: List[str]) -> Query_Builder:
        """Add a list or set of materials referenced by Material ID attribute value to a material query.
...
class _PartQueryBuilder(_RecordBasedQueryBuilder, ABC):
    ...
    def with_part_numbers(self: Query_Builder, part_numbers: List[str]) -> Query_Builder:
        """Add a list or set of parts referenced by part number to a part query.
...
class _SpecificationQueryBuilder(_RecordBasedQueryBuilder, ABC):
    ...
    def with_specification_ids(self: Query_Builder, specification_ids: List[str]) -> Query_Builder:
        """Add a list or set of specifications referenced by specification ID to a specification query.
...
class _SubstanceQueryBuilder(_RecordBasedQueryBuilder, ABC):
    ...
    def with_cas_numbers(self: Query_Builder, cas_numbers: List[str]) -> Query_Builder:
        """Add a list or set of CAS numbers to a substance query. The amount of substance in the material will be set to
        100%.
    ...
    def with_ec_numbers(self: Query_Builder, ec_numbers: List[str]) -> Query_Builder:
        """Add a list or set of EC numbers to a substance query. The amount of substance in the material will be set to
        100%.
    ...
    def with_chemical_names(self: Query_Builder, chemical_names: List[str]) -> Query_Builder:
        """Add a list or set of chemical names to a substance query. The amount of substance in the material will be
        set to 100%.
    ...
    def with_record_history_ids_and_amounts(
        ...
        """Add a list or set of record history identities and amounts to a substance query. The identity and quantity
    ...
    def with_record_history_guids_and_amounts(
        ...
        """Add a list or set of record history GUID and amounts to a substance query. The GUID and quantity pairs are
    ...
    def with_record_guids_and_amounts(
        ...
        """Add a list or set of record GUID and amounts to a substance query. The GUID and quantity pairs are expressed
        as a tuple, with the amount in units of wt. %.
    ...
    def with_cas_numbers_and_amounts(
        ...
        """Add a list or set of CAS Numbers and amounts to a substance query. The CAS Numbers and quantity pairs are
        expressed as a tuple, with the amount in units of wt. %.
    ...
    def with_ec_numbers_and_amounts(
        ...
        """Add a list or set of EC Numbers and amounts to a substance query. The EC Numbers and quantity pairs are
        expressed as a tuple, with the amount in units of wt. %.
    ...
    def with_chemical_names_and_amounts(
        ...
        """Add a list or set of chemical names and amounts to a substance query. The chemical names and quantity pairs
        are expressed as a tuple, with the amount in units of wt. %.
